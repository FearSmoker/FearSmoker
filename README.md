...
<p>
<img src="https://skillicons.dev/icons?i=react,nextjs,redux,vite,tailwind,html,css" />
</p>
...
`Next.js` • `Redux Toolkit` • `Firestore` • `JWT` • `Cloudinary` • `Multer` • `REST APIs` • `Sanity.io`
